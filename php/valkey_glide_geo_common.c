...
int parse_geo_with_options(zval *options, geo_with_options_t *opts)
{
    ...
    else
    {
        ...
        ZEND_HASH_FOREACH_VAL(ht, entry)
        {
            if (Z_TYPE_P(entry) == IS_STRING &&
                (strcasecmp(Z_STRVAL_P(entry), "withcoord") == 0))
            {
                opts->withcoord = 1;
                break;
            }
    ...
    else
    {
        ...
        {
            if (Z_TYPE_P(entry) == IS_STRING &&
                (strcasecmp(Z_STRVAL_P(entry), "withdist") == 0))
            {
                opts->withdist = 1;
                break;
            }
    ...
    else
    {
        ...
        {
            if (Z_TYPE_P(entry) == IS_STRING &&
                (strcasecmp(Z_STRVAL_P(entry), "withhash") == 0))
            {
                opts->withhash = 1;
                break;
            }
...
int parse_geo_radius_options(zval *options, geo_radius_options_t *opts)
{
    ...
    else
    {
        ...
        {
            if (Z_TYPE_P(entry) == IS_STRING &&
                (strcasecmp(Z_STRVAL_P(entry), "any") == 0))
            {
                opts->any = 1;
                break;
            }
    ...
    else
    {
        ...
        {
            if (Z_TYPE_P(entry) == IS_STRING &&
                (strcasecmp(Z_STRVAL_P(entry), "storedist") == 0))
            {
                opts->store_dist = 1;
                break;
            }
 ...
 */
int prepare_geo_key_args(geo_command_args_t *args, uintptr_t **args_out,
 ...
 */
int prepare_geo_members_args(geo_command_args_t *args, uintptr_t **args_out,
                             unsigned long **args_len_out,
 ...
 */
int prepare_geo_dist_args(geo_command_args_t *args, uintptr_t **args_out,
                          unsigned long **args_len_out)
{
    /* Check if client, key, src, dst are valid */
    if (!args || !args->key || !args->src_member || !args->dst_member ||
        !args_out || !args_len_out)
    {
        return 0;
    }
 ...
 */
int prepare_geo_add_args(geo_command_args_t *args, uintptr_t **args_out,
                         unsigned long **args_len_out,
                         char ***allocated_strings, int *allocated_count)
{
    /* Check if client, key, and args are valid */
    if (!args || !args->key || !args->geo_args || args->geo_args_count < 3 ||
        args->geo_args_count % 3 != 0 || !args_out || !args_len_out ||
    ...
    *allocated_count = 0;
    ...
    /* Prepare command arguments */
    unsigned long arg_count = 1 + args->geo_args_count; /* key + (longitude, latitude, member) triplets */
    *args_out = (uintptr_t *)emalloc(arg_count * sizeof(uintptr_t));
    *args_len_out = (unsigned long *)emalloc(arg_count * sizeof(unsigned long));
 ...
 */
int prepare_geo_radius_args(geo_command_args_t *args, uintptr_t **args_out,
                            unsigned long **args_len_out,
                            char ***allocated_strings, int *allocated_count)
{
    /* Check if client and key are valid */
    if (!args || !args->key || !args->unit ||
        !args_out || !args_len_out || !allocated_strings || !allocated_count)
    {
        return 0;
    }
 ...
 */
int prepare_geo_search_args(geo_command_args_t *args, uintptr_t **args_out,
                            unsigned long **args_len_out,
                            char ***allocated_strings, int *allocated_count)
{
    /* Check if client is valid */
    if (!args || !args->key || !args->from || !args->by_radius || !args->unit ||
        !args_out || !args_len_out || !allocated_strings || !allocated_count)
    {
        return 0;
    }
 ...
 */
int prepare_geo_search_store_args(geo_command_args_t *args, uintptr_t **args_out,
                                  unsigned long **args_len_out,
                                  char ***allocated_strings, int *allocated_count)
{
    /* Check if client is valid */
    ...
    if (result->response->response_type == Array)
    {
        ...
        for (size_t i = 0; i < result->response->array_value_len; i++)
        {
            ...
            if (element->response_type == Array && element->array_value_len == 2)
            {
                ...
                {
                    add_next_index_double(&position_array,
                                          element->array_value[0].float_value);
                }
                ...
                {
                    add_next_index_double(&position_array,
                                          element->array_value[1].float_value);
                }
    ...
    geo_result_processor_t process_result)
{
    ...
    case GeoAdd:
        ...
        arg_count = prepare_geo_add_args(args, &arg_values, &arg_lens,
                                         &allocated_strings, &allocated_count);
        break;
    ...
    case GeoPos:
        ...
        arg_count = prepare_geo_members_args(args, &arg_values, &arg_lens,
                                             &allocated_strings, &allocated_count);
        break;
    ...
    case GeoRadius:
        ...
        arg_count = prepare_geo_radius_args(args, &arg_values, &arg_lens,
                                            &allocated_strings, &allocated_count);
        break;
    ...
    case GeoSearch:
        ...
        arg_count = prepare_geo_search_args(args, &arg_values, &arg_lens,
                                            &allocated_strings, &allocated_count);
        break;
    ...
    case GeoSearchStore:
        ...
        arg_count = prepare_geo_search_store_args(args, &arg_values, &arg_lens,
                                                  &allocated_strings, &allocated_count);
        break;
