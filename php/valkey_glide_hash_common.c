                              ...
                              h_result_processor_t process_result)
{
    ...
    {
    case HLen:
        arg_count = prepare_h_key_only_args(args, &cmd_args, &args_len, &allocated_strings, &allocated_count);
        break;
    case HGet:
    case HExists:
    case HStrlen:
        arg_count = prepare_h_single_field_args(args, &cmd_args, &args_len, &allocated_strings, &allocated_count);
        break;
    case HSetNX:
        arg_count = prepare_h_field_value_args(args, &cmd_args, &args_len, &allocated_strings, &allocated_count);
        break;
    case HDel:
    case HMGet:
    ...
    case HIncrByFloat:
        ...
        break;
    case HRandField:
        arg_count = prepare_h_randfield_args(args, &cmd_args, &args_len, &allocated_strings, &allocated_count);
        break;
    case HKeys:
    case HVals:
    case HGetAll:
                             ...
                             int response_type)
{
    ...
    if (result)
    {
        ...
        case H_RESPONSE_STRING:
            status = handle_string_response(result, ((char ***)result_ptr)[0], ((size_t **)result_ptr)[1]);
            break;
                               ...
                               char ***allocated_strings, int *allocated_count)
{
    ...
    *allocated_count = 0;
    ...
    return convert_zval_array_to_args(args->fields, 1, *args_out, *args_len_out,
                                      *allocated_strings, allocated_count, args->field_count);
}
                       ...
                       char ***allocated_strings, int *allocated_count)
{
    ...
    if (args->is_array_arg)
    {
        ...
        *allocated_count = 0;
        ...
        return process_field_value_pairs(z_array, *args_out, *args_len_out, 1,
    ...
    else
    {
        ...
        *allocated_count = 0;
        ...
        return convert_zval_array_to_args(args->field_values, 1, *args_out, *args_len_out,
                                          *allocated_strings, allocated_count, args->fv_count);
    }
}
                        ...
                        char ***allocated_strings, int *allocated_count)
{
    ...
    *allocated_count = 0;
    ...
    /* Process field-value pairs */
    return process_field_value_pairs(args->field_values, *args_out, *args_len_out, 1,
                                     *allocated_strings, allocated_count);
}
...
int process_h_randfield_result(CommandResult *result, void *output)
{
    ...
    if (result->response)
    {
        ...
        else if (args->count != 1 && !args->withvalues && result->response->response_type == Array)
        {
            size_t i;
                                  ...
                                  double increment, double *output_value)
{
    ...
    return execute_h_generic_command(glide_client, HIncrByFloat, &args, output_value, process_h_incrbyfloat_result);
}
