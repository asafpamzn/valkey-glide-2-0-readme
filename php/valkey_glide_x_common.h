...
typedef int (*x_arg_preparation_func_t)(x_command_args_t *args, uintptr_t **args_out,
                                        unsigned long **args_len_out,
                                        char ***allocated_strings, int *allocated_count);
typedef int (*x_simple_arg_preparation_func_t)(x_command_args_t *args, uintptr_t **args_out,
                                               unsigned long **args_len_out);
